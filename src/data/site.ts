...
export const projects: readonly Project[] = [
  {
    ...
    gallery: [
     // { stage: 'finished', src: '/Ather/finished/aether-finished-01.jpg', width: 5393, height: 4045, alt: 'Front elevation of the two completed villas in soft overcast light' },
      ...
      { stage: 'design', src: '/Ather/design/aether-design-08.jpg', width: 3266, height: 4083, alt: 'Villa-01 first floor plan' },
      { stage: 'design', src: '/Ather/design/VILLA -1.jpg', width: 3266, height: 4083, alt: 'Villa-01 first floor plan' },
      { stage: 'design', src: '/Ather/design/VILLA-2.jpg', width: 3266, height: 4083, alt: 'Villa-01 first floor plan' },
      //{ stage: 'design', src: '/Ather/design/VILLA-3.jpg', width: 3266, height: 4083, alt: 'Villa-01 first floor plan' },
      //{ stage: 'design', src: '/Ather/design/VILLA-4.jpg', width: 3266, height: 4083, alt: 'Villa-01 first floor plan' },
