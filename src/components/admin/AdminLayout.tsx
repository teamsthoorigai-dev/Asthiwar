...
export function AdminLayout({
  ...
  return (
    <div className="admin-console min-h-screen bg-background text-foreground flex flex-col md:flex-row">
      {/* Mobile Top Bar */}
      <div className="md:hidden flex items-center justify-between px-4 py-3 border-b border-border bg-surface sticky top-0 z-30">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xs tracking-wide">ASTHIWAR Admin</span>
        </div>
        <button
          type="button"
          onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
          className="p-1.5 rounded text-foreground hover:bg-surface-active cursor-pointer"
      ...
      {/* Sidebar */}
      <aside
        className={`w-full md:w-64 border-r border-border bg-surface p-4 flex flex-col justify-between shrink-0 ${
